...
{
  tf::StampedTransform currentEefTransform;
  tfListener.waitForTransform(eefLink,baseLink,ros::Time::now(), ros::Duration(3.0));
  tfListener.lookupTransform(baseLink,eefLink, ros::Time(1.0), currentEefTransform);
